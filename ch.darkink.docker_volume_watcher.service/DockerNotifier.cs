...
namespace ch.darkink.docker_volume_watcher
{
    public class DockerNotifier
    {
        ...
        public DockerNotifier(string container, string hostDirectory, string destination, Action<DockerNotifier> releaseNotifier, ILogger log, Boolean ignoreFileMandatory, Int32 notifierAction)
        {
        ...
        {
            m_Log.Log(LogLevel.Information, message);
        }
